...
class AttendanceRules {
  ...
  static bool get canCheckout {
    ...
    final cutoff = DateTime(now.year, now.month, now.day,
        checkoutCutoffHour, checkoutCutoffMinute);
...
class AttendanceProvider extends ChangeNotifier {
  ...
  String get fabActionLabel {
    switch (_status) {
      case AttendanceProviderStatus.notCheckedIn: return 'Check-In';
      case AttendanceProviderStatus.checkedIn:    return 'Check-Out / Istirahat';
      case AttendanceProviderStatus.onBreak:      return 'Selesai Istirahat';
      case AttendanceProviderStatus.breakEnded:   return 'Check-Out';
      case AttendanceProviderStatus.checkedOut:   return 'Sudah Selesai';
    }
  }
